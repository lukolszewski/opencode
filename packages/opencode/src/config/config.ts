...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      thinking_toggle: z.string().optional().default("ctrl+o").describe("Toggle all thinking blocks visibility"),
      tool_details_toggle: z.string().optional().default("ctrl+t").describe("Toggle all tool details visibility"),
